<div class="secondary-nav-holder">
	<div id="secondary-nav" class="nav-newsroom">
		<h1><a href="<?php echo $baseUrl; ?>newsroom/">Newsroom: Tagline goes here</a></h1>
		<ul class="secondary-nav">
			...
			<li<?php if (strpos($_SERVER['REQUEST_URI'], 'newsroom/media-and-identity-materials/infocus/quarterly/business/review') !== false) echo ' class="thispage"'; ?>><a href="<?php echo $baseUrl; ?>newsroom/media-and-identity-materials/infocus/quarterly/business/review" class="media-assets"><em>in</em>FOCUS Quarterly Business Review</a></li>
		</ul>
	</div>
</div>