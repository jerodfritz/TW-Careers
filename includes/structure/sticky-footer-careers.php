...
<p style="margin-top:50px; background-color:#FFFFFF;">&nbsp;</p>
...
<div id="footer-holder-bg" class="hidden"></div>-->
	...
	<br />
        <div class="footer-content-careers">
		<!--<ul class="social">
        ...
        <ul class="links-careers">
			<li><a href="<?php echo $baseUrl; ?>careers/disclaimer/" title="Disclaimer">Disclaimer</a></li>
			<li><a href="https://careers.timewarner.com/1033/ASP/TG/help/TG_help.asp?partnerid=391&siteid=36" title="Help">Help</a></li>
			<li><a href="<?php echo $baseUrl; ?>careers/international-privacy-policies/" title="International Privacy Policies">International Privacy Policies</a></li>
		</ul>
		<ul class="links">
